...
namespace SBReceiver
{
    class Program
    {
        const string connectionString = "Endpoint=sb://dglzservicebus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=Gs4UvPsCv8jBfGTB1NSMvhD4LkppZB8OpIhGsaVvWLE=";
